...
$msg .= " " . $input->created_by . " ";

$msg .= " " . $input->full_name . " ";*/

//$msg = " should be sthg " . $obj->form->content->4 . " ";


//$msg = " should be sthg " . $obj->form->content->{4} . " ";

//$msg = $input[0]['form']['content']['4'];


//$track['artist']['#text']

//$obj[0]->commentsbox_count.

// send email
mail("michaelsmuts@gmail.com","My contents",$msg);

//http://test-sw2.com/facilities/calendar/calendar-insert.php
/*$id, 
$start, 
$finish, 
$resource_id, 
