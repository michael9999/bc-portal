    ...
    class wpptopdfenh
    {
        ...
        function wpptopdfenh()
        {
            ...
            if (is_admin()) {
                ...
                add_action( 'wpcf7_before_send_mail', array( $this, 'generate_pdf_cf7' ) );
...
// ------------------------   GENERATE PDF MY VERSION


function generate_pdf_cf7($cf7, $forceDownload = false)
        {
 
 if($cf7->posted_data["hidden-310"] == "test-form"){           
            // REMOVE
...
/*
            $hiddenid = $cf7->posted_data["hidden-310"];
            $email = $cf7->posted_data["your-email"];
			$name = $cf7->posted_data["your-name"];
			$message = "cf7 to pdf trial " . $name . " " . $email . " hidden field id: " . $hiddenid;
			$to = "michaelsmuts@gmail.com";
			$subject = "test email from form plugin200: inside plugin CLASS";	
...
$email = $cf7->posted_data["your-email"];
$name = $cf7->posted_data["your-name"];
$pdf_file_name = $name . "-" . $email;

// --------- ADD NEW PATH AND FILE NAME -----------------

            

            //$filePath = WPPT0PDFENH_CACHE_DIR . '/' . $post->post_name . '.pdf';

$filePath = WPPT0PDFENH_CACHE_DIR . '/' . $pdf_file_name . '.pdf';
...
// IMPORTANT, CREATES PDF INSTANCE
            // add some style fo the html 
...
// @@@@@@@ ------------- IMPORTANT, this is where the html is loaded into the DOM

// BUILD HTML DOM 

$html .= '<table><tr><td><table class="first" cellpadding="4" cellspacing="6">
 <tr>
  <td class="border" width="60" align="center"><b>yellow</b></td>
  <td class="border" width="30" align="center" bgcolor="#FFFF00"><b>yellow</b></td>
 ...
 <tr>
  ...
  <td width="30" align="center" bgcolor="#FFFF00"><b>XXXX</b></td>
 ...
 <table class="first" cellpadding="4" cellspacing="6">
 <tr>
  <td width="60" align="center"><b>PO No.</b></td>
  <td width="30" align="center" bgcolor="#FFFF00"><b>XXXX</b></td>
  <td width="80" align="center"><b></b></td>
  <td width="30" align="center"><b>4</b></td>
   <td width="30" align="center"><b>5</b></td>
...
//$html .= include_once(WPPT0PDFENH_PATH . '/simplehtmldom/temp-devis1.html');
...
//$html .= "<div><h1>Hi, this is our pdf trial ". $email . " " . 	$name . "</h1></div>"; 
...
//$attachments = array( WP_CONTENT_DIR . '/uploads/file_to_attach.zip' ); $filePath

$attachments = array( $filePath );
$email = $cf7->posted_data["your-email"];
			$name = $cf7->posted_data["your-name"];
				//insert_newsletter_subscriber($email, $name);
			$message = "cf7 to pdf trial " . $name . " " . $email . " " . $filePath;
			$to = "michaelsmuts@gmail.com";
			$subject = "Conditional send: file attachment trial";	
			wp_mail( $to, $subject, $message, $headers, $attachments );	
...
// @@@@@@@@ ***********  END OF generate_pdf_file





// -------- end generate pdf, my version
