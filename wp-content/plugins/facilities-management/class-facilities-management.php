...
class facilities_management {
	...
	private function __construct() {
		...
		// Sign in BC users automatically
		
		add_action('template_redirect', array( $this, 'my_auto_login'));
		...
		//add_filter('login_redirect',  array( $this,'my_login_redirect', 10));
...
//wp_enqueue_script( $this->plugin_slug . '-admin-script', plugins_url( 'js/admin.js', __FILE__ ), array( 'jquery' ), $this->version );
	...
	public function enqueue_styles() {
		...
		//wp_enqueue_style( $this->plugin_slug . '-plugin-styles', plugins_url( 'css/bc-sign-up.css', __FILE__ ), array(), $this->version );
		
		
		// this page 712 allows BC staff to sign up for a PEEP survey and be registered for the facilities portal.
	...
	public function fm_display_front($content) {
			...
			include_once( 'views/bc-staff-sign-up.php' );
			//$toppic = 'page1.png';
			
			} 
			
// allows ordinary data to be returned
...
public function f_m_get_provider_profession(){
    ...
    if( is_page(712) && isset($_POST['email']) && isset($_POST['fm_add'])){
        
        // ------------------- start 
// check recaptcha

//remove white space captcha
...
if( null == email_exists( $_POST['email'] ) ) {
		  ...
		  $user_id2 = wp_create_user( $_POST['email'], $password, $_POST['email'] );
            ...
            $to = $_POST['email'];
            $subject = "British Council, Paris: Access to FM site";
            $message = "Thank you for creating an account for the FM information portal.\r\n\r\n";
            $message .= "Your password is: " . $password . "\r\n\r\n";
            $message .= "If you have any questions or encounter difficulties using the site then please contact us at\r\n\r\n solutions@foris-scientia.com \r\n\r\n";
            ...
            $to = "michaelsmuts@gmail.com";
            $subject = "British Council, FM site Paris: new user" . $_POST['email'];
            $message = "A new account has been created\r\n\r\n";
            $message .= "user is: " . $_POST['email'] . "\r\n\r\n";
 ...
 // end email check
    ...
    //echo "anti spam test not passed";
...
// Attempt to log user in from CF7 form


// REDIRECT LOGIN PAGE IF BC STAFF
...
function my_login_redirect(){
    if( is_page(712)) {
         ...
         $url = 'http://www.test-sw2.com/facilities/form-1/';
