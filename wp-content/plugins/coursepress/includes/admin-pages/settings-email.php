...
<div id="poststuff" class="metabox-holder m-settings email-settings cp-wrap">
    <form action='' method='post'>
        ...
        <?php if ( $this->is_marketpress_active() ) { ?>
            <div class="postbox">
                <h3 class="hndle" style='cursor:auto;'><span><?php _e('MarketPress New Order E-mail', 'cp'); ?></span></h3>
                <div class="inside">
        ...
        <div class="postbox">
            <h3 class="hndle" style='cursor:auto;'><span><?php _e('Instructor Invitation E-mail', 'cp'); ?></span></h3>
            <div class="inside">
