...
<div id="comments">
	...
	<?php 
		...
		if ( ! comments_open() && is_singular() ) { ?><h3 class="nocomments"><?php _e( 'Comments are closed.', 'woothemes' ); ?></h3><?php }
		else { ?><h3 class="nocomments"><?php _e( 'No comments yet.', 'woothemes' ); ?></h3><?php }
	?>
